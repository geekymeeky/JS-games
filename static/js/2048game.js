document.addEventListener('DOMContentLoaded', () => {
    ...
    function addColors() {
      for (let i=0; i<squares.length; i++) {
        if (squares[i].innerHTML == 0) squares[i].style.backgroundColor = '#CAD5E2'
        else if (squares[i].innerHTML == 2) squares[i].style.backgroundColor = '#50DBB4'
        else if (squares[i].innerHTML  == 4) squares[i].style.backgroundColor = '#6AC47E'
        else if (squares[i].innerHTML  == 8) squares[i].style.backgroundColor = '#38CC77'
        else if (squares[i].innerHTML  == 16) squares[i].style.backgroundColor = '#66AD47'
        else if (squares[i].innerHTML  == 32) squares[i].style.backgroundColor = '#1FAA59'
        else if (squares[i].innerHTML == 64) squares[i].style.backgroundColor = '#22CB5C'
        else if (squares[i].innerHTML == 128) squares[i].style.backgroundColor = '#6EC72D'
        else if (squares[i].innerHTML == 256) squares[i].style.backgroundColor = '#00D84A'
        else if (squares[i].innerHTML == 512) squares[i].style.backgroundColor = '#4DD637'
        else if (squares[i].innerHTML == 1024) squares[i].style.backgroundColor = '#1C8D73'
        else if (squares[i].innerHTML == 2048) squares[i].style.backgroundColor = '#3DBE29'
      }
    }
    addColors()
